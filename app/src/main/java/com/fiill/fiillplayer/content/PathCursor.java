...
public class PathCursor extends AbstractCursor {
    final List<FileItem> mFileList = new ArrayList<>();
    ...
    PathCursor(File parentDirectory, File[] fileList) {
        ...
        if (fileList != null) {
            ...
            mFileList.add(new FileItem(Environment.getExternalStorageDirectory()));
        }
    }
    ...
    public boolean isNull(int column) {
        return mFileList.get(column) == null;
    }

    public static Comparator<FileItem> sComparator = (lhs, rhs) -> {
    ...
    private static final Set<String> sMediaExtSet = new TreeSet<>(String.CASE_INSENSITIVE_ORDER);

    static {
        sMediaExtSet.add("flv");
        sMediaExtSet.add("mp4");
        sMediaExtSet.add("mpg");
